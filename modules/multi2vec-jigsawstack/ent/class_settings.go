...
func NewClassSettings(cfg moduletools.ClassConfig) *classSettings {
	return &classSettings{
		cfg:  cfg,
		base: basesettings.NewBaseClassSettingsWithAltNames(cfg, false, "multi2vec-jigsawstack", nil, nil),
	}
}

// JigsawStack settings
...
func (ic *classSettings) getNumber(in interface{}) (float32, error) {
	...
	case int64:
		return float32(v), nil
	default:
		return 0, errors.Errorf("cannot convert %#v to float32", in)
	}
} 